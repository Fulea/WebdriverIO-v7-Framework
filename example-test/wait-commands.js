// These tests will have false-positive results because of timeouts
...
//     clickMeButton.click();
//   }); //test should fail... even though its in the DOM doesnt mean it clickable
...
//     clickMeButton.waitForEnabled(10000, true); //will check whether the element is enabled and wait for it to turn false (Become Disabled) - should cause the test to fail
//     clickMeButton.waitForEnabled(10000, false); //will check whether the element is enabled - should pass

//     //true: waits for element to become disabled- this test should fail
//     browser.pause(8000);
//     clickMeButton.waitForEnabled(10000, true);
//     clickMeButton.click();

//     false: waits for element to become enabled - this test should pass
//     browser.pause(8000);
